...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/d0x-dev/Airbeats",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+fGrj2zocLnk4ZGY1")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/stormxvup")

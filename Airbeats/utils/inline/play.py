...
from Airbeats.utils.formatters import time_to_seconds
...
def stream_markup_timer(_, vidid, chat_id, played, dur):
    ...
    return [
        ...
        [
            InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="https://t.me/SongPY"),
            InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/stormxvup"),
        ],

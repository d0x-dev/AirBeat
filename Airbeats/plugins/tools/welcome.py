...
def welcomepic(pic, user, chatname, id, uname):
    background = Image.open("Airbeats/assets/Brandedwel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('Airbeats/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('Airbeats/assets/font.ttf', size=60)
...
async def greet_group(_, member: ChatMemberUpdated):
    ...
    try:
        ...
        pic = "Airbeats/assets/Brandedwel2.png"
...
๏ 𝐌𝐀𝐃𝐄 𝐁𝐘 ➠ [𖣐᪵‌𖡡꯭𝆭𐎓⏤‌‌𝑫ꫝ𝒓𝒌𝒃𝒐𝒚 ꯭𖠌𐎙ꭙ‌‌⁷ 📿](https://t.me/SongPY)
➖➖➖➖➖➖➖➖➖➖➖
""",

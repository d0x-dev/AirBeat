...
from Airbeats.mongo.afkdb import LOGGERS as OWNERS
from Airbeats.utils.database import add_served_chat, get_assistant
            ...
            [
                [
                    InlineKeyboardButton(
                        "ƨσʋяcɛ", url=f"https://github.com/d0x-dev/Airbeats"
                    )
                ]
            ]
        ),
